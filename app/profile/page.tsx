    ...
    const renderStatusBadge = () => {
        if (user.is_premium) {
            if (user.stripe_cancel_at_period_end) {
                return (
                    <div className="inline-flex items-center px-3 py-1 rounded-full bg-yellow-500/10 border border-yellow-500/20 text-yellow-400 text-xs font-medium">
        ...
        return (
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-zinc-500/10 border border-zinc-500/20 text-zinc-400 text-xs font-medium">
                Free Plan
            </div>
        );
    };
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div className="bg-zinc-900/30 border border-white/5 p-6 rounded-xl">
                        ...
                        <p className="text-zinc-300 font-mono text-xs mt-1 truncate" title={user.id}>{user.id}</p>
                    </div>
                    <div className="bg-zinc-900/30 border border-white/5 p-6 rounded-xl">
